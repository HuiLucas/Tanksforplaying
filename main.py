...
for level in range(1, 10):
    ...
    player_tank = custom.Tank(-np.pi / 2 - 0.2, (20, 30), 8, RED, boundary_angle, False, 5, cool_off_time)
    # AI tank list
    ...
    while running:
        ...
        if level_won_check:
            ...
            screen.blit(level_won_text, (display_width/2 - level_won_text.get_width()/2, 100))

            choose_upgrade_text = font1.render("Choose upgrade:", False, WHITE)
            screen.blit(choose_upgrade_text, (display_width / 2 - choose_upgrade_text.get_width() / 2, 200))
